...
// sayHello('Mono');
// var helloMessage = 'hello ,Mono';
// console.log(helloMessage);

//class demo

var helloMessage = sayHello("mono");
console.log(helloMessage)
...
// calculateTip(num){
//      return alert ("Hello, "+ num);
//     }
//        calculateTip(prompt("Enter tip ammount:"));
//
// function sayHello(name){
//     return alert ("Hello, "+ name);
// }
...
// console.log(Number('3.25').toFixed(2));
//

var calculateTip = calculateTip(tipPercent,billTotal);
