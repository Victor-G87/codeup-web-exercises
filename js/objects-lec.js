...
alert("hey yall i own a"+ myCar.model + myCar.make )

myCar.freatures =["heated seats","leather","things"]

for(var i =0 ; i < myCar.freatures.length; i++){
    console.log("cars features: "+ myCar.freatures[i])
}
...
myCar.turnOn = function() {
    alert("putting the key in the ignition " + myCar.make + " " + myCar.model + "just fine")
}
...
garage.forEach(function (cars){
    console.log("cars the the garage" + cars)
})
